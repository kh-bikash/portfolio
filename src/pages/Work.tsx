...
import { Text, Float, RoundedBox, useCursor, ScrollControls, Scroll } from "@react-three/drei"
...
function ExperienceScene() {
    ...
    return (
        // @ts-ignore
        <ScrollControls pages={pages} damping={0.3} style={{ zIndex: 10 }} htmlProps={{ "data-lenis-prevent": true }}>
            {/* 3D Content */}
            <Scroll>
...
export default function Work() {
    ...
    // We allow Lenis to run; ScrollControls creates a separate scroll container usually, or if it uses body, Lenis helps.
    // If ScrollControls conflicts, we might need a different approach, but freezing Lenis likely breaks input.
